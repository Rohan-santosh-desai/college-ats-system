"use client"; // <--- Essential for onClick events
...
export default function LoginPage() {
  ...
  const handleLogin = () => {
    // This triggers the Google Login and redirects to home after success
      ...
      <div className="w-full max-w-md space-y-8 rounded-xl bg-white p-10 shadow-2xl">
        ...
        <div className="text-center">
          ...
          <p className="mt-2 text-sm text-gray-600">
            Sign in to the College Placement System
          </p>
        </div>
            ...
            <span className="mr-3 inline-flex items-center">
              ...
              >
                <g transform="matrix(1, 0, 0, 1, 27.009001, -39.238998)">
                  ...
                  <path
                    fill="#EA4335"
                    d="M -14.754 43.989 C -12.984 43.989 -11.404 44.599 -10.154 45.799 L -6.734 42.379 C -8.804 40.439 -11.514 39.239 -14.754 39.239 C -19.444 39.239 -23.494 41.939 -25.464 45.859 L -21.484 48.949 C -22.424 46.099 -25.064 43.989 -14.754 43.989 Z"
                  />
                </g>
              </svg>
            </span>
